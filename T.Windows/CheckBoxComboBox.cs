...
{
    /*
    public class CheckBoxComboBox<T> : CheckBoxComboBox where T : class
    {
        private List<T> _selectedItems;

        public List<T> TItems { get; set; }

        public List<T> SelectedItems { get { SetSelectedItems(); return _selectedItems; } }
        ...
        public void AddItems(List<T> items)
        {
            ...
            {
                Items.Add(new CheckBoxComboBoxItem(this, item));
            }
        }
        ...
        private void SetSelectedItems()
        {
            ...
            CheckBoxComboBoxItem val;

            foreach (object item in CheckBoxItems)
            {
                val = item as CheckBoxComboBoxItem;
                ...
                try
                {
                    _selectedItems.Add((T)((val.ComboBoxItem)));
                }
                catch
                {
                    val = val.ComboBoxItem as CheckBoxComboBoxItem;
    ...
    */
    ...
    public partial class CheckBoxComboBox : PopupComboBox
    {
        ...
        public Type ItemType { get { return _itemType; } }

        private Type _itemType;

        private List<object> _selectedItems;

        public List<object> TItems { get; set; }

        public List<object> SelectedItems { get { SetSelectedItems(); return _selectedItems; } }
        ...
        public List<T> GetSelectedItems<T>()
        {
            ...
            foreach (object item in CheckBoxItems)
            {
                ...
                try
                {
                    selectedItems.Add((T)val.ComboBoxItem);
                }
                catch
                {
                    val = val.ComboBoxItem as CheckBoxComboBoxItem;
        ...
        private void SetSelectedItems()
        {
            ...
            _selectedItems = GetSelectedItems<object>();            
        }
        ...
        public CheckBoxComboBox() : base()
        {
            ...
            DropDownControl.BackColor = Color.Black;
        }
    ...
    public class CheckBoxComboBoxItem : CheckBox
    {
        ...
        protected override void OnCheckedChanged(EventArgs e)
        {
            ...
            else
            {
                try
                {
                    PropertyInfo PI = ComboBoxItem.GetType().GetProperty("Checked");
                    if(PI != null)
                        PI.SetValue(ComboBoxItem, Checked, null);
                }
                catch
